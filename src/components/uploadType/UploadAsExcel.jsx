...
export default function UploadAsExcel() {
    ...
    const [selectedColumn, setSelectedColumn] = useState(''); // Only one column state
    ...
    return (
        <div className="flex flex-col items-center mt-8 p-4 text-center w-full sm:w-4/5 md:w-3/5 lg:w-2/5 mx-auto">
            ...
            <p className="text-sm sm:text-base text-gray-700 mb-6">
                Please upload your Excel file and select the column to visualize data.
            </p>
            ...
            <button
                ...
                disabled={!selectedColumn} // Disable if column not selected
            >
                Generate Charts
            </button>
            ...
            {showCharts && fileData && (
                <div className="mt-8 w-full flex flex-col items-center">
                    {/* ReusableChart will render based on selected column */}
                    <ReusableChart data={fileData} column={selectedColumn} />
                </div>
            )}
        </div>
    );
